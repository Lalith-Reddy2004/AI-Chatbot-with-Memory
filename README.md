...
A conversational AI assistant with persistent memory using LangChain's conversation buffer. Integrates tool calling for real-time web search and structured responses.
---
